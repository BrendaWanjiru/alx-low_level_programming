...
/**
 * check98 - checks whether file_from exists and is readable
 * @check: checks if content is true of false
 * @file: file_from name
...
/**
 * check100 - checks if file descriptors are properly closed
 * @check: checks if content is true or false
 * @fd: file descriptor
 *
 * Return: void
 */
